        ...
        <div class="card">
            ...
            <div class="card-header card-header-stretch">
                ...
                <div class="card-title">
                    ...
                    <!--begin::Menu 3-->
                    <div wire:ignore.self class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                        data-kt-menu="true">
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">Cari Jenis Barang</div>
                            <input wire:model="search" type="text" class="form-control form-control-solid" placeholder="Cari .."
                                name="target_title" />
                        </div>
                        <!--end::Menu item-->
                        <br>
                        ...
                        <table class="table table-row-bordered align-middle gy-6">
                            ...
                            <tbody class="fs-6 fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td class="ps-0">
                                        <span class="text-gray-600 text-hover-primary">{{ $data->nama_jenis }}</span>
                                    </td>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form wire:submit.prevent="store()" id="kt_modal_new_target_form" class="form" action="#">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label
                                class="d-flex align-items-center fs-6 fw-semibold mb-2 @error('nama_jenis') text-danger @enderror">
                                <span class="required">Nama</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                    title="Masukan Nama Jenis Barang"></i>
                            </label>
                            <!--end::Label-->
                            <input wire:model.lazy="nama_jenis" type="text" class="form-control form-control-solid"
                                name="target_title" />
                            @error('nama_jenis')
