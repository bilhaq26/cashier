<div>
    ...
    <div id="kt_app_aside" class="app-aside flex-column z-inde-1" data-kt-drawer="true" data-kt-drawer-name="app-aside"
        ...
        <!--begin::Navbar-->
        <div class="app-navbar flex-stack flex-shrink-0 mt-lg-3 p-5 py-lg-12 px-lg-14" id="kt_app_aside_navbar">
            <!--begin:Author-->
            <div class="d-flex align-items-center me-2">
                ...
                <div class="d-none d-lg-block m-0">
                    <a href="../../demo8/dist/pages/user-profile/overview.html"
                        class="text-gray-800 text-hover-primary fs-4 fw-bold">Ja Morant</a>
                    <span class="text-gray-400 fw-semibold d-block">UI/UX Design Lean</span>
                </div>
                <!--end:Info-->
            </div>
            <!--end:Author-->
            ...
            <div class="app-navbar-item">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                    ...
                    <div class="row g-0">
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="../../demo8/dist/apps/projects/budget.html"
                        ...
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="../../demo8/dist/apps/projects/settings.html"
                        ...
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="../../demo8/dist/apps/projects/list.html"
                        ...
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="../../demo8/dist/apps/projects/users.html"
                    ...
                    <div class="py-2 text-center border-top">
                        <a href="../../demo8/dist/pages/user-profile/activity.html"
        ...
        <!--end::Navbar-->
        <!--begin::Content-->
        <div id="kt_app_aside_content_wrapper"
            class="app-aside_content-wrapper hover-scroll-overlay-y ps-5 ps-lg-14 pe-3 pe-lg-14 pb-10"
            data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto"
            data-kt-scroll-dependencies="#kt_app_aside_navbar" data-kt-scroll-wrappers="#kt_app_aside_content"
            data-kt-scroll-offset="5px">
            <!--begin::List widget 29-->
            <div class="card card-flush card-p-0 card-reset bg-transparent mb-7 mb-lg-15">
                <!--begin::Header-->
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="fw-bold text-gray-800">Top Clients</span>
                        <span class="text-muted mt-3 fw-semibold fs-6">240,000 Total Sales</span>
                    </h3>
                    <!--begin::Toolbar-->
                    <div class="card-toolbar">
                        <!--begin::Menu-->
                        <button class="btn btn-icon btn-color-primary btn-active-color-primary justify-content-end"
                ...
                <div class="card-body pt-8">
                    ...
                    <div class="d-flex flex-stack mb-6">
                        <!--begin::Logo-->
                        <img src="assets/media/svg/brand-logos/bp-2.svg" class="me-5 w-35px" alt="" />
                        <!--end::Logo-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">BP Industries</a>
                                <span class="text-gray-400 fw-semibold d-block pt-1">Oil & Gas</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Actions-->
                    ...
                    <div class="d-flex flex-stack mb-6">
                        <!--begin::Logo-->
                        <img src="assets/media/svg/brand-logos/suzuki.svg" class="me-5 w-35px" alt="" />
                        <!--end::Logo-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            <!--begin:Author-->
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">Automatica</a>
                                <span class="text-gray-400 fw-semibold d-block pt-1">Cars, Bikes, Trucks</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
                    ...
                    <div class="d-flex flex-stack mb-6">
                        <!--begin::Logo-->
                        <img src="assets/media/svg/brand-logos/python-5.svg" class="me-5 w-35px" alt="" />
                        <!--end::Logo-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            <!--begin:Author-->
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">Pythpn Inc.</a>
                                <span class="text-gray-400 fw-semibold d-block pt-1">Programming</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
                    ...
                    <div class="d-flex flex-stack mb-6">
                        <!--begin::Logo-->
                        <img src="assets/media/svg/brand-logos/beats-electronics.svg" class="me-5 w-35px" alt="" />
                        <!--end::Logo-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            <!--begin:Author-->
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">Beats Audio</a>
                                <span class="text-gray-400 fw-semibold d-block pt-1">Audio Industry</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
                    ...
                    <div class="d-flex flex-stack">
                        <!--begin::Logo-->
                        <img src="assets/media/svg/brand-logos/node-sass.svg" class="me-5 w-35px" alt="" />
                        <!--end::Logo-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            <!--begin:Author-->
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-700 text-hover-primary fs-6 fw-bold">Sass Tech.</a>
                                <span class="text-gray-400 fw-semibold d-block pt-1">CSS Solution</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
            ...
            <!--end::List widget 29-->
            <!--begin::List widget 32-->
            <div class="card card-reset bg-transparent card-p-0">
                <!--begin::Header-->
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-dark">Authors Progress</span>
                        <span class="text-muted mt-3 fw-semibold fs-6">Avarage +47%</span>
                    </h3>
                    <!--begin::Toolbar-->
                    <div class="card-toolbar">
                        <!--begin::Menu-->
                        <button class="btn btn-icon btn-color-primary justify-content-end" data-kt-menu-trigger="click"
                ...
                <div class="card-body pt-6">
                    ...
                    <div class="d-flex flex-stack mb-7">
                        ...
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-800 text-hover-primary fs-6 fw-bold">Marcus Smart</a>
                                <span class="text-muted fw-semibold d-block">UI/UX, Art Director</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Total-->
                            <span class="text-primary fw-bolder d-block fs-6 me-3">+65%</span>
                            <!--begin::Total-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen057.svg-->
                                <span class="svg-icon svg-icon-2qx svg-icon-gray-400">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="5"
                                            fill="currentColor" />
                    ...
                    <div class="d-flex flex-stack mb-7">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-35px me-4">
                            <div class="symbol-label fs-6 fw-bold bg-light-info text-info">AH</div>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-800 text-hover-primary fs-6 fw-bold">Andreas Hawks</a>
                                <span class="text-muted fw-semibold d-block">Python Developer</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Total-->
                            <span class="text-primary fw-bolder d-block fs-6 me-3">+23%</span>
                            <!--begin::Total-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen057.svg-->
                    ...
                    <div class="d-flex flex-stack mb-7">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-35px me-4">
                            <div class="symbol-label fs-6 fw-bold bg-light-primary text-primary">SC</div>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-800 text-hover-primary fs-6 fw-bold">Sarah Connor</a>
                                <span class="text-muted fw-semibold d-block">HTML, CSS. jQuery</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Total-->
                            <span class="text-danger fw-bolder d-block fs-6 me-3">-34%</span>
                            <!--begin::Total-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen057.svg-->
                    ...
                    <div class="d-flex flex-stack mb-7">
                        ...
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-800 text-hover-primary fs-6 fw-bold">Amanda Harden</a>
                                <span class="text-muted fw-semibold d-block">UI/UX Designer</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Total-->
                            <span class="text-primary fw-bolder d-block fs-6 me-3">+72%</span>
                            <!--begin::Total-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen057.svg-->
                    ...
                    <div class="d-flex flex-stack mb-7">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-35px me-4">
                            <div class="symbol-label fs-6 fw-bold bg-light-danger text-danger">SR</div>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-800 text-hover-primary fs-6 fw-bold">Sean Robbins</a>
                                <span class="text-muted fw-semibold d-block">UI/UX, Art Director</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Total-->
                    ...
                    <div class="d-flex flex-stack">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-35px me-4">
                            <div class="symbol-label fs-6 fw-bold bg-light-primary text-primary">JT</div>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Section-->
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            ...
                            <div class="flex-grow-1 me-2">
                                <a href="../../demo8/dist/pages/user-profile/overview.html"
                                    class="text-gray-800 text-hover-primary fs-6 fw-bold">Jason Tatum</a>
                                <span class="text-muted fw-semibold d-block">ASP.NET Developer</span>
                            </div>
                            <!--end:Author-->
                            <!--begin::Total-->
                            <span class="text-primary fw-bolder d-block fs-6 me-3">+139%</span>
                            <!--begin::Total-->
                            <!--begin::Actions-->
                            <a href="#" class="text-hover-primary">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen057.svg-->
